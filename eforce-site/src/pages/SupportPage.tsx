    ...
    <>
      ...
      <section className="bg-white pt-32 pb-16 md:pt-40">
        ...
        >
          ...
          <p className="mx-auto mt-6 max-w-2xl font-body text-lg text-brand-text-secondary">
      ...
      <section className="bg-white py-16">
        ...
        >
          <h2 className="mb-8 font-display text-2xl font-bold text-brand-text-primary">
          ...
          <div className="divide-y divide-brand-border">
            {faqData.map((item, index) => (
              <div key={index}>
                ...
                >
                  <span className="pr-4 font-display text-base font-medium text-brand-text-primary">
                    {item.question}
                  </span>
                  <svg
                    className={`h-5 w-5 flex-shrink-0 text-brand-text-secondary transition-transform duration-300 ${
                ...
                >
                  <p className="pb-5 font-body text-sm leading-relaxed text-brand-text-secondary">
                    {item.answer}
                  </p>
                </motion.div>
              </div>
      ...
      <section className="bg-[#f7f7f7] py-24">
        <div className="mx-auto max-w-5xl px-6">
          <h2 className="mb-8 text-center font-display text-2xl font-bold text-brand-text-primary">
            Downloads
          </h2>
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <div
                key={file.name}
                className="flex items-center justify-between rounded-xl border border-brand-border bg-[#f7f7f7] p-5 transition-colors hover:border-brand-orange/30"
              >
                <div>
                  <p className="font-display text-sm font-semibold text-brand-text-primary">{file.name}</p>
                  <p className="mt-1 font-mono text-xs text-brand-text-secondary">
                    {file.type} — {file.size}
                  </p>
                </div>
                <svg
                  className="h-5 w-5 flex-shrink-0 text-brand-text-secondary"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth={2}
      ...
      <section className="bg-white py-24">
        ...
        >
          <h2 className="mb-2 text-center font-display text-2xl font-bold text-brand-text-primary">
            Contact Us
          </h2>
          <p className="mb-8 text-center font-body text-brand-text-secondary">
          ...
          >
            <div className="grid gap-5 sm:grid-cols-2">
              <input
                type="text"
                placeholder="Name"
                className="rounded-lg border border-brand-border bg-[#f7f7f7] px-4 py-3 font-body text-sm text-brand-text-primary placeholder:text-brand-text-secondary/50 focus:border-brand-orange/50 focus:outline-none focus:ring-1 focus:ring-brand-orange/50"
              />
              <input
                type="email"
                placeholder="Email"
            ...
            <select className="w-full rounded-lg border border-brand-border bg-[#f7f7f7] px-4 py-3 font-body text-sm text-brand-text-primary focus:border-brand-orange/50 focus:outline-none focus:ring-1 focus:ring-brand-orange/50">
            ...
            <textarea
              ...
              className="w-full rounded-lg border border-brand-border bg-[#f7f7f7] px-4 py-3 font-body text-sm text-brand-text-primary placeholder:text-brand-text-secondary/50 focus:border-brand-orange/50 focus:outline-none focus:ring-1 focus:ring-brand-orange/50"
            />
            <button
              type="submit"
      ...
      <section className="bg-[#f7f7f7] py-24">
        <div className="mx-auto max-w-3xl px-6 text-center">
          <h2 className="font-display text-2xl font-bold text-brand-text-primary">Warranty</h2>
          <p className="mx-auto mt-4 max-w-xl font-body leading-relaxed text-brand-text-secondary">
