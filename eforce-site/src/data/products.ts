...
export const products: Product[] = [
  ...
  },
  {
    ...
    specsImage: "/assets/images/kits/ef2v3/ef2v3-specs-new.png",
    editorialHeadline: undefined,
    editorialBody: undefined,
    galleryImages: [
  ...
  },
  {
    ...
    specsImage: "/assets/images/kits/ef5v2/ef5v2-specs-copper.png",
    ...
    highlights: [
      { image: "/assets/images/kits/ef5v2/ef5v2-dest-3.png", title: "Módulo F50.", description: "O poder e a força de um módulo altamente tecnológico, moderno e profissional.", objectFit: "contain" as const },
      { image: "/assets/images/kits/ef5v2/ef5v2-dest1.png", title: "Novo pé de bumbo Odery.", description: "Estrutura sólida que proporciona estabilidade e segurança. Pode ser usado na âncora ou na borracha (com troca rápida).", objectFit: "cover" as const, objectPosition: "bottom", cardWidth: "clamp(306px, 34vw, 450px)", scale: 1.05 },
      ...
      { image: "/assets/images/kits/ef5v2/ef5v2-dest-7.png", title: "Pensada em cada detalhe.", description: "Plaquinha de identificação como a cereja do bolo afinal, cada detalhe importa. Cada detalhe eleva o nível de percepção de qualidade e-Force.", objectFit: "cover" as const, cardWidth: "clamp(500px, 62vw, 780px)" },
