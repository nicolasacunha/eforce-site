  ...
  return (
    <section className="py-24 px-6 text-center">
      <div className="max-w-2xl mx-auto">
        <p className="text-gray-500 text-sm mb-8">O som não é apenas bom. Ele proporciona uma experiência emocionante.</p>
        <button onMouseDown={handleStart} onMouseUp={handleStop} onMouseLeave={handleStop} onTouchStart={handleStart} onTouchEnd={handleStop} className="relative w-24 h-24 rounded-full border-2 border-gray-300 hover:border-brand-orange transition-colors mx-auto flex items-center justify-center group" aria-label="Segure para ouvir">
