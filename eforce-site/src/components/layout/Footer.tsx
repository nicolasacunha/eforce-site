      ...
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-500">
            <li><Link to={`/${lang}`} className="hover:text-gray-900 transition-colors">{t("nav.home")}</Link></li>
            <li><Link to={`/${lang}/line`} className="hover:text-gray-900 transition-colors">{t("nav.line")}</Link></li>
            <li><Link to={`/${lang}/technology`} className="hover:text-gray-900 transition-colors">{t("nav.technology")}</Link></li>
          </ul>
        </div>
        <div>
          <h4 className="font-display font-bold text-sm tracking-wider mb-4">{t("nav.story")}</h4>
          <ul className="space-y-2 text-sm text-gray-500">
            <li><Link to={`/${lang}/story`} className="hover:text-gray-900 transition-colors">{t("nav.story")}</Link></li>
            <li><Link to={`/${lang}/news`} className="hover:text-gray-900 transition-colors">{t("nav.news") || "News"}</Link></li>
          </ul>
        </div>
        <div>
          <h4 className="font-display font-bold text-sm tracking-wider mb-4">{t("nav.dealers")}</h4>
          <ul className="space-y-2 text-sm text-gray-500">
            <li><Link to={`/${lang}/dealers`} className="hover:text-gray-900 transition-colors">{t("nav.dealers")}</Link></li>
            <li><Link to={`/${lang}/support`} className="hover:text-gray-900 transition-colors">{t("nav.support") || "Suporte"}</Link></li>
          </ul>
        </div>
        <div>
          ...
          <div className="flex gap-4 text-gray-500">
            ...
            <a href="#" className="hover:text-gray-900 transition-colors" aria-label="TikTok">
